...
namespace _02.CarSalesman
{
    public class RunProgram
    {
        public static void Run()
        {
            ...
            GenerateEngine(engines);
            GenerateCar(cars, engines);
        ...
        private static void GenerateCar(List<Car> cars, List<Engine> engines)
        {
        ...
        private static void GenerateEngine(List<Engine> engines)
        {
